...
Simon Wood) and [lme4](https://cran.r-project.org/package=lme4)
(authors: Douglas M. Bates, Martin Maechler, Ben Bolker, and Steve
Walker). Places where this occurs have been marked with comments in the
source code.
