# Contributing to galamm

This outlines how to propose a change to galamm. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("LCBC-UiO/galamm", fork = TRUE)`.
...
of Conduct](https://lcbc-uio.github.io/galamm/CODE_OF_CONDUCT.md). By
contributing to this project you agree to abide by its terms.

## Roadmap

This package is in a stable state of development, with some degree of
active subsequent development as envisioned by the primary authors.
