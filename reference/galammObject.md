...
An S3 class for objects returned by
[`galamm()`](https://lcbc-uio.github.io/galamm/reference/galamm.md).
Contains information about the fitted model, random effects, parameters,
and smooth terms.
...
- `model`: a list containing:
  ...
  - `factor_interactions`: list of formulas for latent-observed
    interactions.
  ...
  - `lmod`: linear model object from
    [`lme4::lFormula()`](https://rdrr.io/pkg/lme4/man/modular.html).
