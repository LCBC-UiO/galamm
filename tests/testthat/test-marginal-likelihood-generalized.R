...
test_that("ML GLMM works", {
  ...
  expect_equal(final_model$hessian, structure(c(-32.3851312969134, -3.51068800537797, 0.619024744034724,
                                                ...
                                                0.795541672068818, -6.03673215094414), dim = c(5L, 5L)), tolerance = 1e-4)
