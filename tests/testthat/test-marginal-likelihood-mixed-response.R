...
test_that("mixed response works", {
  expect_equal(opt$par, c(
    0.957958409447422, 1.06067106767555, 0.285720962425644, 0.0405115541598134,
    0.974239048611714
  ))
  expect_equal(opt$value, -4619.2040054477)
  expect_equal(fmod$phi, c(1.13721269186597, 1))
  expect_equal(fmod$hessian, structure(c(
    -411.301473824064, 3.38190917660314, -26.5042352287512,
    ...
    -320.701676050362, -292.801074301447
  ), dim = c(5L, 5L)))
})
