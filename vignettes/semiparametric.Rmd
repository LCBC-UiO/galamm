...
We can now move on to the part of the cognition data that is binomially distributed. We begin with domain 2, for which there is a single trial. In this case there are only two items, so we must change the lambda matrix accordingly.
