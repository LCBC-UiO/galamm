...
#> At iterate   100  f =      -1062.4  |proj g|=        400.16
#> At iterate   150  f =      -1069.1  |proj g|=        151.55
#> At iterate   200  f =      -1147.5  |proj g|=        44.829
#> 
#> iterations 207
#> function evaluations 228
#> segments explored during Cauchy searches 210
#> BFGS updates skipped 0
#> active bounds at final generalized Cauchy point 0
#> norm of the final projected gradient 5.59584
#> final function value -1147.55
#> 
#> F = -1147.55
#> final  value -1147.545485 
#> converged
```
...
#> 
#>      AIC      BIC   logLik deviance df.resid 
#>  -2259.1  -2127.3   1147.5  -2295.1    11182 
#> 
#> Scaled residuals: 
#>      Min       1Q   Median       3Q      Max 
#> -2097.48 -1025.93  -872.88    18.74    46.92 
#> 
#> Lambda:
...
#> lambda7        .        .   1.9994 0.0015665
#> 
#> Random effects:
#>  Groups       Name                  Variance Std.Dev. Corr 
#>  timepoint:id domain1:ability1       0.23641 0.4862        
#>               domain3:ability3       0.28011 0.5293   -0.01
#>  id           domain1:ability1       2.22291 1.4909        
#>               domain3:ability3      22.71304 4.7658   0.65 
#>  Xr.0         s(x):domain3:ability3 40.45375 6.3603        
#>  Xr           s(x):domain1:ability1  9.81843 3.1334        
#>  Residual                            0.01007 0.1003        
#> Number of obs: 11200, groups:  timepoint:id, 1600; id, 200; Xr.0, 8; Xr, 8
#> 
#> Fixed effects:
#>                            Estimate Std. Error t value  Pr(>|t|)
#> (Intercept)              -0.0029364   0.004648 -0.6317 5.276e-01
#> domain3                   0.0000136   0.007556  0.0018 9.986e-01
#> s(x):domain1:ability1Fx1 -0.0861681   0.216332 -0.3983 6.904e-01
#> s(x):domain3:ability3Fx1  5.7635009   0.307665 18.7331 2.662e-78
#> 
#> Approximate significance of smooth terms:
#>                         edf Ref.df     F p-value
#> s(x):domain1:ability1 8.929  8.929  4314  <2e-16
#> s(x):domain3:ability3 8.975  8.975 59677  <2e-16
```
