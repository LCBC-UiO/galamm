...
$$
\eta = \gamma_{1} x + \gamma_{2}x^{2} + \zeta.
$$

The reduced form of the model is

$$
y_{i} = \beta_{i} + \lambda_{i} \gamma_{1}x + \lambda_{i} \gamma_{2} x^{2} + \lambda_{i} \zeta + \epsilon_{i}
$$
...
$$
y_{i} = \beta_{i} + \lambda_{i} h(x) + \lambda_{i} \zeta + \epsilon_{i}
$$
...
The factor loadings are very well recovered.
