...
#' @srrstats {G1.0} Key references introduced below.
#' @srrstats {G1.1} The paragraph below states that this is the first place where the algorithm is implemented.
#' @srrstats {G1.2} Contains repo status badge.
#' @srrstats {G1.3} All statistical terminology clarified and defined in vignettes, as well as in more detail in the open access Psychometrika paper (Sørensen, Fjell, and Walhovd, 2023) which is the key reference.
```
