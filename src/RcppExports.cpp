...
RcppExport SEXP _galamm_compute_galamm(SEXP ySEXP, SEXP XSEXP, SEXP ZtSEXP, SEXP LambdatSEXP, SEXP LindSEXP, SEXP thetaSEXP, SEXP theta_logSEXP, SEXP maxit_outerSEXP, SEXP familySEXP, SEXP trialsSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXi> >::type theta_log(theta_logSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(compute_galamm(y, X, Zt, Lambdat, Lind, theta, theta_log, maxit_outer, family, trials));
