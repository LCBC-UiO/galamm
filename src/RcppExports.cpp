...
// compute_galamm
Rcpp::List compute_galamm(const Eigen::Map<Eigen::VectorXd> y, const Eigen::Map<Eigen::VectorXd> trials, const Eigen::Map<Eigen::MatrixXd> X, const Eigen::MappedSparseMatrix<double> Zt, const Eigen::MappedSparseMatrix<double> Lambdat, const Eigen::Map<Eigen::VectorXd> beta, const Eigen::Map<Eigen::VectorXd> theta, const Eigen::Map<Eigen::VectorXi> theta_mapping, const Eigen::Map<Eigen::VectorXd> lambda, const Eigen::Map<Eigen::VectorXd> lambda_mapping_X, const Eigen::Map<Eigen::VectorXd> lambda_mapping_Zt, const std::string family);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type lambda_mapping_X(lambda_mapping_XSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type lambda_mapping_Zt(lambda_mapping_ZtSEXP);
